...
abstract class $HomeModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String title, String description, int? level});
}
...
class _$HomeModelImpl implements _HomeModel {
  ...
  @override
  String toString() {
    return 'HomeModel(id: $id, title: $title, description: $description, level: $level)';
  }
...
abstract class _HomeModel implements HomeModel {
  factory _HomeModel(
      ...
      final int? level}) = _$HomeModelImpl;
